...
/** ------------------------------------------------------------------------------------------------------------------------------- **/
    ...
    //GIVING YOUR BLOCK A CRAFTING RECIPE
        ...
        public static void Recipitate() {
            ...
            GameRegistry.addRecipe(new ItemStack(chicken_block1, 1), new Object[]
                    {
                            "YYY",
                            "XXX",
                            "YYY",
                        'Y', BlockInit.chicken_block,
                        'X', Blocks.SAND,
                    }); 
        }
...
/** ------------------------------------------------------------------------------------------------------------------------------- **/
    ...
    //TELLING MINECRAFT ABOUT YOUR BLOCK    
        ...
        public static Block chicken_block1;
    
        public static void init() {
        	chicken_block = new CustomOre("chicken_block", 3.0F, 4.0F, 2);
        	chicken_block1 = new CustomOre("chicken_block1", 3.0F, 4.0F, 2);
        }
